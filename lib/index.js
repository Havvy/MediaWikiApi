...
/**
 * Handles calling the proper events for library EventEmitters
 */
var handle = function (ee, err, res) {
...
MediaWikiApi.prototype = {
    ...
    categorymembers: function (category, options, callback) {
        ...
        for (var option in options) {
            query['cm' + option] = options[option];
        }
    ...
    search: function (searchString, options, callback) {
        ...
        for (var option in options) {
            query['sr' + option] = options[option];
        }
